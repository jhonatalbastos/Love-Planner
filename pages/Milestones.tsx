          ...
          <div className="grid gap-3">
            {ACHIEVEMENTS_LIST.map((ach) => {
              ...
              return (
                <div
                  key={ach.id}
                  className={`group relative flex items-center gap-4 rounded-xl p-4 border transition-all ${unlocked
                ...
                >
                  <div className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-full text-2xl ${unlocked ? 'bg-orange-100 text-orange-500 dark:bg-orange-500/20' : 'bg-gray-200 dark:bg-white/10 text-gray-400'
                    }`}>
