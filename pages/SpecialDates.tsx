...
export const SpecialDates: React.FC<Props> = ({ onBack }) => {
  ...
  const addSpecialDate = useContentStore(state => state.addSpecialDate);
  const updateSpecialDate = useContentStore(state => state.updateSpecialDate);
  const deleteSpecialDate = useContentStore(state => state.deleteSpecialDate);
